...
export async function rankTracker(keywordTracking, targetDomain){
    let browser;
    try {
        ...
        for(let gPage = 0; gPage <5; gPage++){
            await page.goto(`https://www.google.com/search?q=${encodeURIComponent(keywordTracking)}&start=${gPage * 10}&num=10&h1=en&gl=us`, {waitUntil: "networkidle"})
