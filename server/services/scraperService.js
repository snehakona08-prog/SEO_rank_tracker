       ...
       const session = await bb.sessions.create({browserSettings : {blockAds: true}});
               ...
               const scrapedData = await page.evaluate(()=>{
                ...
                const headings = {
                  h1:document.querySelectorAll("h1").length,
                   h2:document.querySelectorAll("h1").length,
                    h3:document.querySelectorAll("h1").length,
                     h4:document.querySelectorAll("h1").length,
                      h5:document.querySelectorAll("h1").length,
                       h6:document.querySelectorAll("h1").length,
                       h1Texts,
                };
                ...
                return {
                  metaData: {title, description, canonical, robots, ogTitle, ogDescription, canonical, robots, ogTitle, ogDescription, ogImage, twitterCard, viewport, charset},
                  headings,
        ...
        if(browser){
          try {
            ...
            console.error("[SCREPER] Browser close failed:", error.message);
          }
        }
    }
}